...
if not classicMode then
	data:extend({
		...
		},
		{
			...
			energy_required = 50,
			ingredients = {
				{ "exoskeleton-equipment", 50 * productionCost },
				{ "belt-immunity-equipment", 50 * productionCost },
				{ "radar", 50 * productionCost },
				{ "rocket-control-unit", 100 * productionCost },
				{ "battery-mk2-equipment", 20 * productionCost },
				{ "power-armor-mk2", 5 * productionCost },
				{ "fusion-reactor-equipment", 10 * productionCost },
			},
		...
		},
		{
			...
			energy_required = 50,
			ingredients = {
				{ "exploration-data-disk", 20 * productionCost },
			},
			result = "space-map",
		},
	})
